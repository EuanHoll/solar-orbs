...
public class ItemSolarWand extends ToolItem
{
	
	public ItemSolarWand(Properties builder) {
		super(2f, 2f, new WandToolMaterial(25, EventSubscriber.solar_orb), null, builder);
	}
